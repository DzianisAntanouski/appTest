...
export const config: wdi5Config = {
    wdi5: {
        ...
        url: "https://apptest-firebase-b0b0c.web.app/#", // [mandatory] {string} name of your bootstrap html file. If your server autoredirects to a 'domain:port/'-like root url, use empty string ''
